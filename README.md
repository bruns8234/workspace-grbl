# com-chilipeppr-workspace-grbl-v1
A ChiliPeppr Workspace for grbl. For new firmware v1



## ChiliPeppr Workspace / grbl-v1
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-grbl-v1 |
| Name                  | Workspace / grbl-v1 |
| Description           | A ChiliPeppr Workspace for grbl. For new firmware v1 |
| chilipeppr.load() URL | http://raw.githubusercontent.com/bruns8234/workspace-grbl-v1.1/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/bruns8234/chilipeppr-workspace-grbl-v1 |
| Github URL            | http://github.com/bruns8234/workspace-grbl-v1.1 |
| Test URL              | https://preview.c9users.io/bruns8234/chilipeppr-workspace-grbl-v1/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/bruns8234/workspace-grbl-v1.1/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-grbl-v1"], // the id you gave your workspace
      function(myWorkspaceGrblV1) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / grbl-v1 just got loaded.", myWorkspaceGrblV1);
        myWorkspaceGrblV1.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-grbl-v1"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / grbl-v1"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace for grbl. For new firmware v1"</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/bruns8234/workspace-grbl-v1.1/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/bruns8234/chilipeppr-workspace-grbl-v1"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/bruns8234/workspace-grbl-v1.1"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://chilipeppr-workspace-grbl-v1-bruns8234.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
